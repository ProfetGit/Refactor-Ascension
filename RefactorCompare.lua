...
local CLASS_SPEC_WEIGHTS = {
    BARBARIAN = {
        { name = "Headhunting", weights = { AGI = 1, AP = 0.5, DPS = 8, HIT = 0.9, CRIT = 0.8, HASTE = 0.6, ARP = 0.7, STA = 0.4, SOCKET = 20, UNKNOWN = 0.1 } },
        { name = "Brutality",   weights = { AGI = 1, STR = 0.6, AP = 0.5, DPS = 8, HIT = 0.9, EXP = 0.85, CRIT = 0.7, HASTE = 0.6, ARP = 0.6, STA = 0.4, SOCKET = 20, UNKNOWN = 0.1 } },
        { name = "Ancestry",    weights = { AGI = 1, AP = 0.5, DPS = 8, HASTE = 0.9, CRIT = 0.7, HIT = 0.9, STA = 0.8, EXP = 0.8, SOCKET = 20, UNKNOWN = 0.1 } },
    },
    BLOODMAGE = {
        { name = "Fleshweaver", weights = { SP = 1, INT = 0.8, SPI = 0.7, HASTE = 0.6, CRIT = 0.5, STA = 0.4, MP5 = 0.5, SOCKET = 20, UNKNOWN = 0.1 } },
        { name = "Senguine",    weights = { SP = 1, INT = 0.8, STA = 0.9, HIT = 0.9, HASTE = 0.8, CRIT = 0.7, SOCKET = 20, UNKNOWN = 0.1 } },
        { name = "Accursed",    weights = { AGI = 1, SP = 0.8, INT = 0.5, AP = 0.5, DPS = 8, HIT = 0.9, CRIT = 0.7, HASTE = 0.6, EXP = 0.8, STA = 0.5, SOCKET = 20, UNKNOWN = 0.1 } },
        { name = "Eternal",     weights = { STA = 1.5, AGI = 0.8, DEF = 0.9, DODGE = 0.8, ARMOR = 0.02, PARRY = 0.5, SOCKET = 20, UNKNOWN = 0.1 } },
    },
    CHRONOMANCER = {
        { name = "Time",      weights = { SP = 1, INT = 0.8, SPI = 0.7, HASTE = 0.6, CRIT = 0.5, MP5 = 0.5, STA = 0.3, SOCKET = 20, UNKNOWN = 0.1 } },
        { name = "Infinite",  weights = { SP = 1, INT = 0.8, HIT = 0.9, HASTE = 0.7, CRIT = 0.6, STA = 0.3, SOCKET = 20, UNKNOWN = 0.1 } },
        { name = "Artificer", weights = { SPI = 1, SP = 0.5, INT = 0.5, DPS = 8, HIT = 0.9, HASTE = 0.8, CRIT = 0.7, STA = 0.4, MP5 = 0.2, SOCKET = 20, UNKNOWN = 0.1 } },
        { name = "Duality",   weights = { SP = 1, INT = 0.8, HIT = 0.9, CRIT = 0.7, HASTE = 0.6, STA = 0.3, SOCKET = 20, UNKNOWN = 0.1 } },
    },
    CULTIST = {
        { name = "Godblade",    weights = { STR = 1, SP = 0.8, INT = 0.4, AP = 0.5, DPS = 8, HIT = 0.9, HASTE = 0.6, CRIT = 0.7, EXP = 0.8, STA = 0.5, SOCKET = 20, UNKNOWN = 0.1 } },
        { name = "Corruption",  weights = { SP = 1, INT = 0.8, HIT = 0.9, HASTE = 0.8, CRIT = 0.7, STA = 0.4, SOCKET = 20, UNKNOWN = 0.1 } },
        { name = "Influence",   weights = { SP = 1, INT = 0.8, SPI = 0.7, HASTE = 0.6, CRIT = 0.5, STA = 0.4, MP5 = 0.4, SOCKET = 20, UNKNOWN = 0.1 } },
        { name = "Dreadnought", weights = { STA = 1.5, STR = 0.5, DEF = 0.9, ARMOR = 0.02, BLOCK = 0.8, INT = 0.2, SP = 0.2, SOCKET = 20, UNKNOWN = 0.1 } },
    },
    FELSWORN = {
        { name = "Infernal", weights = { SP = 1, INT = 0.8, HIT = 0.9, HASTE = 0.8, CRIT = 0.7, STA = 0.4, SOCKET = 20, UNKNOWN = 0.1 } },
        { name = "Slayer",   weights = { AGI = 1, AP = 0.5, DPS = 8, HIT = 0.9, HASTE = 0.8, CRIT = 0.7, EXP = 0.8, STA = 0.5, SOCKET = 20, UNKNOWN = 0.1 } },
        { name = "Tyrant",   weights = { AGI = 1, STA = 1.5, DODGE = 0.9, DEF = 0.8, ARMOR = 0.02, AP = 0.3, SOCKET = 20, UNKNOWN = 0.1 } },
    },
    GUARDIAN = {
        { name = "Gladiator",   weights = { STR = 1, AP = 0.5, DPS = 8, HIT = 0.9, ARP = 0.8, CRIT = 0.7, HASTE = 0.6, EXP = 0.8, STA = 0.5, SOCKET = 20, UNKNOWN = 0.1 } },
        { name = "Vanguard",    weights = { STA = 1.5, DEF = 1, BLOCK = 0.9, STR = 0.4, ARMOR = 0.02, PARRY = 0.7, DODGE = 0.6, SOCKET = 20, UNKNOWN = 0.1 } },
        { name = "Inspiration", weights = { STA = 1.5, HASTE = 0.9, STR = 0.8, AP = 0.4, DEF = 0.5, ARMOR = 0.02, SOCKET = 20, UNKNOWN = 0.1 } },
    },
    KNIGHT_OF_XOROTH = {
        { name = "Hellfire", weights = { STR = 1, SP = 0.8, INT = 0.4, AP = 0.5, DPS = 8, HIT = 0.9, CRIT = 0.7, HASTE = 0.6, EXP = 0.8, STA = 0.5, SOCKET = 20, UNKNOWN = 0.1 } },
        { name = "Defiance", weights = { STA = 1.5, DEF = 0.9, ARMOR = 0.02, STR = 0.4, BLOCK = 0.8, PARRY = 0.6, SOCKET = 20, UNKNOWN = 0.1 } },
        { name = "War",      weights = { STR = 1, AP = 0.5, DPS = 8, HIT = 0.9, ARP = 0.8, CRIT = 0.7, EXP = 0.8, STA = 0.5, SOCKET = 20, UNKNOWN = 0.1 } },
    },
    NECROMANCER = {
        { name = "Death",     weights = { SP = 1, INT = 0.8, HIT = 0.9, HASTE = 0.8, CRIT = 0.6, STA = 0.3, SOCKET = 20, UNKNOWN = 0.1 } },
        { name = "Animation", weights = { SP = 1, INT = 0.8, HIT = 0.9, HASTE = 0.7, CRIT = 0.6, STA = 0.3, SOCKET = 20, UNKNOWN = 0.1 } },
        { name = "Rime",      weights = { SP = 1, INT = 0.8, HIT = 0.9, CRIT = 0.8, HASTE = 0.6, STA = 0.3, SOCKET = 20, UNKNOWN = 0.1 } },
    },
    PRIMALIST = {
        { name = "Grovekeeper",   weights = { SP = 1, INT = 0.8, STR = 0.7, AP = 0.3, HASTE = 0.6, CRIT = 0.5, SPI = 0.5, MP5 = 0.4, STA = 0.5, SOCKET = 20, UNKNOWN = 0.1 } },
        { name = "Wild_Walker",   weights = { STR = 1, AP = 0.5, DPS = 8, HIT = 0.9, CRIT = 0.7, HASTE = 0.6, EXP = 0.8, STA = 0.5, SOCKET = 20, UNKNOWN = 0.1 } },
        { name = "Mountain_King", weights = { STA = 1.5, DEF = 0.9, ARMOR = 0.02, STR = 0.5, BLOCK = 0.8, PARRY = 0.6, DODGE = 0.5, SOCKET = 20, UNKNOWN = 0.1 } },
        { name = "Geomancer",     weights = { SP = 1, INT = 0.8, HIT = 0.9, HASTE = 0.7, CRIT = 0.6, STA = 0.5, SOCKET = 20, UNKNOWN = 0.1 } },
    },
    PYROMANCER = {
        { name = "Incineration", weights = { SP = 1, INT = 0.8, HIT = 0.9, CRIT = 0.8, HASTE = 0.7, STA = 0.3, SOCKET = 20, UNKNOWN = 0.1 } },
        { name = "Draconic",     weights = { SP = 1, INT = 0.8, HIT = 0.9, HASTE = 0.8, STA = 0.6, CRIT = 0.6, SOCKET = 20, UNKNOWN = 0.1 } },
        { name = "Flameweaving", weights = { SP = 1, INT = 0.8, SPI = 0.7, HASTE = 0.6, CRIT = 0.6, MP5 = 0.5, STA = 0.3, SOCKET = 20, UNKNOWN = 0.1 } },
    },
    RANGER = {
        { name = "Archer",     weights = { AGI = 1, AP = 0.5, DPS = 8, HIT = 0.9, CRIT = 0.8, HASTE = 0.6, ARP = 0.7, STA = 0.4, SOCKET = 20, UNKNOWN = 0.1 } },
        { name = "Brigand",    weights = { AGI = 1, AP = 0.5, DPS = 8, HIT = 0.9, ARP = 0.8, CRIT = 0.7, HASTE = 0.6, EXP = 0.8, STA = 0.4, SOCKET = 20, UNKNOWN = 0.1 } },
        { name = "Farstrider", weights = { AGI = 1, STA = 0.8, HASTE = 0.8, AP = 0.4, CRIT = 0.6, HIT = 0.9, SOCKET = 20, UNKNOWN = 0.1 } },
    },
    REAPER = {
        { name = "Harvest",      weights = { STR = 1, AP = 0.5, DPS = 8, HIT = 0.9, CRIT = 0.8, HASTE = 0.6, EXP = 0.8, STA = 0.6, SOCKET = 20, UNKNOWN = 0.1 } },
        { name = "Soul",         weights = { STR = 1, AP = 0.5, DPS = 8, HIT = 0.9, ARP = 0.8, CRIT = 0.7, HASTE = 0.6, EXP = 0.8, STA = 0.6, SOCKET = 20, UNKNOWN = 0.1 } },
        { name = "Bloodletting", weights = { STA = 1.5, STR = 0.5, ARMOR = 0.02, PARRY = 0.8, DEF = 0.7, DODGE = 0.4, SOCKET = 20, UNKNOWN = 0.1 } },
    },
    RUNEMASTER = {
        { name = "Spellslinger", weights = { SP = 1, INT = 0.8, HIT = 0.9, HASTE = 0.8, CRIT = 0.7, STA = 0.3, SOCKET = 20, UNKNOWN = 0.1 } },
    ...
    STARCALLER = {
        ...
        { name = "Warden",      weights = { AGI = 1, INT = 0.4, AP = 0.5, DPS = 8, HIT = 0.9, CRIT = 0.7, HASTE = 0.6, EXP = 0.8, STA = 0.4, SOCKET = 20, UNKNOWN = 0.1 } },
        { name = "Moonguard",   weights = { INT = 1.2, STA = 1, DEF = 0.9, BLOCK = 0.8, PARRY = 0.7, DODGE = 0.4, ARMOR = 0.02, MP5 = 0.3, SOCKET = 20, UNKNOWN = 0.1 } },
    },
    STORMBRINGER = {
        { name = "Tempest", weights = { SP = 1, INT = 0.8, HIT = 0.9, HASTE = 0.8, CRIT = 0.7, STA = 0.3, SOCKET = 20, UNKNOWN = 0.1 } },
        { name = "Static",  weights = { SP = 1, INT = 0.8, HIT = 0.9, CRIT = 0.8, HASTE = 0.6, STA = 0.3, SOCKET = 20, UNKNOWN = 0.1 } },
        { name = "Support", weights = { SP = 1, INT = 0.8, HASTE = 0.8, STA = 0.6, SPI = 0.5, MP5 = 0.4, SOCKET = 20, UNKNOWN = 0.1 } },
    },
    SUN_CLERIC = {
        { name = "Solar",    weights = { SP = 1, INT = 0.8, HIT = 0.9, CRIT = 0.7, HASTE = 0.6, STA = 0.4, SOCKET = 20, UNKNOWN = 0.1 } },
        { name = "Seraphim", weights = { STR = 1, AP = 0.5, DPS = 8, HIT = 0.9, HASTE = 0.8, CRIT = 0.7, EXP = 0.8, STA = 0.5, SOCKET = 20, UNKNOWN = 0.1 } },
        { name = "Valkyrie", weights = { STA = 1.5, DEF = 1, BLOCK = 0.9, STR = 0.5, ARMOR = 0.02, PARRY = 0.6, DODGE = 0.5, SOCKET = 20, UNKNOWN = 0.1 } },
        { name = "Piety",    weights = { SP = 1, INT = 0.8, HASTE = 0.7, CRIT = 0.6, SPI = 0.5, MP5 = 0.4, STA = 0.4, SOCKET = 20, UNKNOWN = 0.1 } },
    },
    TEMPLAR = {
        { name = "Oathkeeper", weights = { STA = 1.5, AGI = 0.8, DEF = 0.9, ARMOR = 0.02, DODGE = 0.6, HASTE = 0.5, SOCKET = 20, UNKNOWN = 0.1 } },
        { name = "Zealot",     weights = { AGI = 1, AP = 0.5, DPS = 8, HIT = 0.9, HASTE = 0.8, CRIT = 0.7, EXP = 0.8, STA = 0.5, SOCKET = 20, UNKNOWN = 0.1 } },
        { name = "Crusader",   weights = { AGI = 1, AP = 0.5, DPS = 8, HIT = 0.9, CRIT = 0.8, HASTE = 0.5, EXP = 0.8, STA = 0.5, SOCKET = 20, UNKNOWN = 0.1 } },
    },
    TINKER = {
        { name = "Demolition",    weights = { AGI = 1, AP = 0.5, DPS = 8, HIT = 0.9, CRIT = 0.8, HASTE = 0.6, ARP = 0.7, STA = 0.4, SOCKET = 20, UNKNOWN = 0.1 } },
        { name = "Gadgetry",      weights = { AGI = 1, AP = 0.5, HIT = 0.9, HASTE = 0.8, CRIT = 0.6, STA = 0.4, SOCKET = 20, UNKNOWN = 0.1 } },
        { name = "Field_Medic",   weights = { SP = 1, INT = 0.8, HASTE = 0.7, CRIT = 0.6, MP5 = 0.6, SPI = 0.5, STA = 0.4, SOCKET = 20, UNKNOWN = 0.1 } },
        { name = "Mechanization", weights = { STA = 1.5, AGI = 0.8, DEF = 0.9, ARMOR = 0.02, DODGE = 0.7, BLOCK = 0.6, SOCKET = 20, UNKNOWN = 0.1 } },
    },
    VENOMANCER = {
        { name = "Fortitude",  weights = { STA = 1.5, INT = 0.6, AGI = 0.8, ARMOR = 0.02, DODGE = 0.8, DEF = 0.7, SOCKET = 20, UNKNOWN = 0.1 } },
        { name = "Stalking",   weights = { AGI = 1, AP = 0.5, DPS = 8, HIT = 0.9, CRIT = 0.7, HASTE = 0.6, EXP = 0.8, STA = 0.5, SOCKET = 20, UNKNOWN = 0.1 } },
        { name = "Rot_Weaver", weights = { SP = 1, HASTE = 0.9, CRIT = 0.8, INT = 0.7, HIT = 0.9, STA = 0.4, SOCKET = 20, UNKNOWN = 0.1 } },
        { name = "Vizir",      weights = { SP = 1, HASTE = 0.9, CRIT = 0.8, INT = 0.7, MP5 = 0.6, STA = 0.4, SOCKET = 20, UNKNOWN = 0.1 } },
    },
    WITCH_DOCTOR = {
        { name = "Shadowhunting", weights = { AGI = 1, AP = 0.5, DPS = 8, HIT = 0.9, HASTE = 0.7, CRIT = 0.6, EXP = 0.8, STA = 0.5, SOCKET = 20, UNKNOWN = 0.1 } },
        { name = "Voodoo",        weights = { SP = 1, INT = 0.8, HIT = 0.9, HASTE = 0.8, CRIT = 0.6, SPI = 0.5, STA = 0.4, SOCKET = 20, UNKNOWN = 0.1 } },
        { name = "Brewing",       weights = { SP = 1, SPI = 0.9, INT = 0.8, HASTE = 0.7, CRIT = 0.6, MP5 = 0.5, STA = 0.4, SOCKET = 20, UNKNOWN = 0.1 } },
    },
    WITCH_HUNTER = {
        { name = "Boltslinger",  weights = { AGI = 1, AP = 0.5, DPS = 8, HIT = 0.9, CRIT = 0.8, HASTE = 0.7, ARP = 0.6, STA = 0.4, SOCKET = 20, UNKNOWN = 0.1 } },
        { name = "Darkness",     weights = { AGI = 1, AP = 0.5, DPS = 8, HIT = 0.9, HASTE = 0.8, CRIT = 0.7, ARP = 0.5, STA = 0.4, SOCKET = 20, UNKNOWN = 0.1 } },
        { name = "Inquisition",  weights = { AGI = 1, AP = 0.5, DPS = 8, HIT = 0.9, CRIT = 0.8, HASTE = 0.7, EXP = 0.8, STA = 0.5, SOCKET = 20, UNKNOWN = 0.1 } },
        { name = "Black_Knight", weights = { STA = 1.5, AGI = 0.8, ARMOR = 0.02, DEF = 0.8, PARRY = 0.6, DODGE = 0.7, SOCKET = 20, UNKNOWN = 0.1 } },
    },
}
...
-- Finds the talent tree the player has spent the most points in (their
-- primary spec). Ties keep whichever tab was checked first. Returns nil
-- before level 10, when no talent points exist to spend yet.
...
local function AutoApplyClassSpec()
    ...
    -- Talent tab names come back as display text ("Moon Priest"); the
    -- table keeps Pawn-style underscored names ("Moon_Priest"). Normalize
    -- both sides before comparing.
    local specName = DetectPrimarySpec()
    local specEntry
    if specName then
        local wanted = specName:lower():gsub(" ", "_")
        for _, s in ipairs(specList) do
            if s.name:lower() == wanted then specEntry = s break end
        end
        if not specEntry and db.debug then
            Print("auto-profile: no weights for spec '" .. specName .. "', using " .. specList[1].name .. ".")
        end
    end
...
-- slot redraw. Buttons are remembered (weak-keyed) so equipment changes
-- can re-evaluate them without waiting for Bagnon's own updates.
...
SlashCmdList.REFACTORCOMPARE = function(msg)
    ...
    elseif cmd == "auto" then
        ...
        -- back to class/spec auto-selection.
...
eventFrame:SetScript("OnEvent", function(self, event, arg1)
    if event == "ADDON_LOADED" then
        -- Bagnon can load before or after this addon; try the hook on
        -- every load until it sticks (no-op once hooked or if absent).
        TryHookBagnon()
